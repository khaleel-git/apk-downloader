...
$file_pointer = "https://d-01.savegoogle.com/apks/dXpOamxCSEo5eWl4Nk9OMmdic3VuZz09/play/$appId.apk";


$get_json = file_get_contents("https://images.apkfuel.com/jsons/$appId.json");
...
<meta charset="utf-8" />
	...
	<title>Download <?php echo $json_obj['title'] ?> | APK for Android</title>
...
.w-button-green-out {align-items: center;background: transparent;border: 0;border-radius: 5px;box-shadow: none;background-color: #F15A24;color: white;cursor: pointer;display: inline-flex;font-size: 1.0em;font-weight: 500;justify-content: center;letter-spacing: 1px;outline: 0;overflow: hidden;padding: 9px 9px;position: relative;text-decoration: none;transition: background-color .2s, box-shadow .2s;-moz-osx-font-smoothing: grayscale;-webkit-font-smoothing: antialiased;text-rendering: optimizeLegibility;box-shadow: 0 2px 4px -1px rgba(0, 0, 0, .2), 0 4px 5px 0 rgba(0, 0, 0, .14), 0 1px 10px 0 rgba(0, 0, 0, .12);outline: none;text-decoration: none;background:linear-gradient(to right,#F15A24 50%,#689f38 50%);background-size:200% 100%;background-position:left bottom;margin-left:10px;transition:all 2s ease }.w-button-green-out:hover {box-shadow: 0 4px 8px -2px rgba(0, 0, 0, .2), 0 8px 10px 0 rgba(0, 0, 0, .14), 0 2px 20px 0 rgba(0, 0, 0, .12);outline: none;text-decoration: none; background-position: right bottom;}.w-button-green-out-disable {cursor: not-allowed;pointer-events: none;color: #9E9E9E;background-color: #e6e6e6;}
	...
	<link rel="stylesheet" href="assets/yellowcircle.css">
	<link rel="stylesheet" href="assets/purplecircle.css">
	<link rel="stylesheet" href="assets/firecircle.css">
	<link rel="stylesheet" href="assets/whitecircle.css">
	<link rel="stylesheet" href="assets/simplecircle.css">
...
<div style="margin-bottom: 2px !important; margin-top: 1px; margin-left:45px; margin-right:45px; display: flex;justify-content: center;align-items: center;">
<strong style="font-family: 'Roboto', sans-serif; font-size: 25px !important; color: #218838"><?php echo $json_obj['title'] ?></strong> </br></div>
<div style="margin-bottom: 5px !important; margin-top: 1px; display: flex;justify-content: center;align-items: center;">
<img  src= "<?php echo $json_obj['image'][1]['imageUrl'] ?>" alt="App icon" width="110"/></br>  </div>
...
<div onload="download()"></div>
				...
				?>
						<!--a id="dl" style="display: none" href="https://apkfuel.com/post-app-downloading/apk_data/<?php echo $appId; ?>.apk" ></a--> 
						<?php #echo "App not exists on Cloud! Downloading from local server"; ?>
				<?php
                #}
				#else
                #{
				?>
						<a id="dl" style="display: none" href="https://d-01.savegoogle.com/apks/dXpOamxCSEo5eWl4Nk9OMmdic3VuZz09/play/<?php echo $appId; ?>.apk" ></a> 
						<?php echo "Downloading from Cloud"; ?>
				<?php
               # }
				?>
...
<a class="w-button" style="margin-top: 6px !important; margin-bottom: 6px !important;  margin-left:45px; margin-right:45px; display: flex;justify-content: center;align-items: center;" href="https://d-01.savegoogle.com/apks/dXpOamxCSEo5eWl4Nk9OMmdic3VuZz09/play/<?php echo $appId; ?>.apk">Click Here</a>
